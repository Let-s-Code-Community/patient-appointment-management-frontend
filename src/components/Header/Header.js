                        ...
                        <div className='col-xl-10 col-12 col-md-10 col-lg-10 mx-auto' >
                            <div className='row container mx-auto  relative -mt-48'>
                                <div className='col-md-4 bg-neutral-100 rounded-tl-lg rounded-bl-lg'>
                                    <div className=' p-4 '>
                                        <i className="bi bi-heart-pulse-fill text-4xl text-primary"></i>
                                        ...
                                        <a href="#" className='text-primary'>Read more  <i className="bi bi-arrow-right-short text-lg "></i></a>
                                    </div>
                                </div>
                                <div className='col-md-4 px-0'>
                                    <div className=' p-4 bg-white'>
                                        <i className="bi bi-calendar2-plus-fill text-4xl text-primary"></i>
                                ...
                                <div className='col-md-4  bg-neutral-100 rounded-tr-lg rounded-br-lg'>
                                    <div className='p-4'>
                                        <i className="bi bi-clock-fill text-4xl text-primary"></i>
